...
public class RuntimeCommand {
	...
	public static void main(String[] args) throws IOException {
		...
		RuntimeCommand rc = getCommandInstance(System.out, "echo", "This is test one!");		
		rc.run();		
		if(rc.hasError()) {
			System.err.println(rc.getErrorOutput());
		}
		
		rc = getCommandInstance("echo", "This is test two!");
		rc.run();		
		if(rc.hasError()) {
			System.err.println(rc.getErrorOutput());
		}
		...
		pw.println("@ECHO OFF");
		pw.println("echo This is test three (a);");
		pw.println("echo This is test three (b);");
		pw.println("echo This is test three (c);");
		pw.flush();
		pw.close();
