...
public abstract class AbstractAwsDAO {
	...
	public static AbstractAwsDAO getInstance(AWSCredentials credentials) {
		return new AbstractAwsDAO(credentials) {
			@Override public Collection<?> getResources() { return null; }			
		};
	}

	/**
	 * All implementers must choose a basic/popular method of their own to proxy a call to this method.
	 * 
	 * @return
	 */
